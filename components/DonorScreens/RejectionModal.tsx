    ...
    <View className="flex-1 justify-center items-center bg-gray-100">
      ...
      >
        ...
        <View className="absolute bottom-0 w-full bg-white rounded-t-2xl p-6 shadow-md">
          ...
          <Text className="text-center text-[14px] text-[#4C4C4C] mb-6">
            Are you sure you want to reject this blood request?😥 You'll be
            saving a life if you accept🥹
          </Text>
      ...
      >
        ...
        <View className="absolute bottom-0 w-full bg-white rounded-t-2xl p-6 shadow-md">
          ...
          <Text className="text-center text-[14px] text-[#4C4C4C] mb-6">
            You have declined this blood request. Click below to return to your
...
export default RejectBloodRequest; 
